...
class AppRadioOutlineGroup<T> extends StatelessWidget {
  ...
  const AppRadioOutlineGroup({
    ...
    this.spacing = 8,
    this.borderRadius = 8,
    this.itemPadding = const EdgeInsets.symmetric(horizontal: 18, vertical: 8),
  });

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context).extension<AppRadioOutlineTheme>()!;
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: colors.border, width: isSelected ? 1.5 : 1),
