...
class AppRadioFilledGroup<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context).extension<AppRadioFilledTheme>()!;
...
class _FilledItem extends StatelessWidget {
